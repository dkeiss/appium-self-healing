 ...
 *
 * {@code rejectedLocators} collects heal suggestions that were previously tried in the current
 * retry loop but could not be resolved against the UI. Passed to the LocatorHealer so the LLM
